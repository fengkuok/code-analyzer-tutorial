...
libraryDependencies ++= Seq(
  ...
  "com.typesafe.akka" %% "akka-persistence-tck" % "2.5.16",
  ...
  "com.typesafe.akka" %% "akka-contrib" % "2.5.16",
...
//mainClass in assembly := Some("lesson1.hello.Main")
